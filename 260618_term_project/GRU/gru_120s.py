...
def main():
    ...
    sequence_length = 10  # 과거 10초(10 time steps)를 보고 예측
    ...
    plt.title("Training and validation MAE (GRU 120s)")
    plt.legend()
    ...
    for figsize, suffix in plot_configs:
        ...
        plt.tight_layout()
        pred_plot_path = os.path.join(os.path.dirname(__file__), f"gru_120s_predictions{suffix}.png")

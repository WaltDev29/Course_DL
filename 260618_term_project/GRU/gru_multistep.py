...
def main():
    ...
    model_save_path = os.path.join(os.path.dirname(__file__), "gru_multistep.keras")
    callbacks = [
    ...
    plt.title("Training and validation MAE (GRU Multi-step)")
    plt.legend()
    
    plot_path = os.path.join(os.path.dirname(__file__), "gru_multistep_loss.png")
    ...
    for figsize, suffix in plot_configs:
        ...
        plt.tight_layout()
        pred_plot_path = os.path.join(os.path.dirname(__file__), f"gru_multistep_predictions{suffix}.png")

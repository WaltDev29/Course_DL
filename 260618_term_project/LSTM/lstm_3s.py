...
def main():
    ...
    model_save_path = os.path.join(os.path.dirname(__file__), "lstm_3s.keras")
    callbacks = [
    ...
    plt.title("Training and validation MAE (LSTM 3s)")
    plt.legend()
    
    plot_path = os.path.join(os.path.dirname(__file__), "lstm_3s_loss.png")
    ...
    for figsize, suffix in plot_configs:
        ...
        plt.tight_layout()
        pred_plot_path = os.path.join(os.path.dirname(__file__), f"lstm_3s_predictions{suffix}.png")

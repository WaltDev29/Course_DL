...
def main():
    ...
    model_save_path = os.path.join(os.path.dirname(__file__), "lstm_30s.keras")
    callbacks = [
    ...
    plt.title("Training and validation MAE (LSTM 30s)")
    plt.legend()
    
    plot_path = os.path.join(os.path.dirname(__file__), "lstm_30s_loss.png")
    ...
    for figsize, suffix in plot_configs:
        ...
        plt.tight_layout()
        pred_plot_path = os.path.join(os.path.dirname(__file__), f"lstm_30s_predictions{suffix}.png")
